...
app.patch("/jokes/:id", (req , res) => {
  const id = parseInt(req.params.id);
  const existingJokes = jpkes.find((joke) => {jokes.id === id});
  const replacementJoke = {
    id: id,
    jokeText: req.body.text || existingJokes.jokeText,
    jokeType: req.body.type || existingJokes.jokeType,
  }
...
app.delete("/jokes/:id", (req , res) => {
  ...
  if(searchIndex > -1) {
    ...
    res.
    status(404)
    .json({error: `Jpkes with id: ${id} not found. 
